...
### Investigation Files
Investigation and analysis scripts are located in `projects/adhoc/`:
- `projects/adhoc/investigate_large_clusters.py` - Investigate large customer clusters
- `projects/adhoc/inspect_actual_customer_details.py` - Inspect customer details
- `projects/adhoc/inspect_cluster_attributes.py` - Inspect cluster attributes
- `projects/adhoc/large_clusters_analysis_summary.md` - Analysis summary

To run investigation scripts:
```bash
python projects/adhoc/investigate_large_clusters.py
```
