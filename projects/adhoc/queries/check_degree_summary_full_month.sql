-- Summary table of customer counts by degree type for full month, all business units
WITH spider_data AS (
  SELECT 
  ...
  FROM parquet.`s3://hf-dp-kts3-avro-pii-live/events/kafka/parquet/topics/public.fraud.checkout.customer.data.v2/year=2025/month=11`
  WHERE 
