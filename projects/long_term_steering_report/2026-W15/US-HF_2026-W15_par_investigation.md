...
**Overall:** Payment Approval Rate improved marginally from 93.63% to 93.76% (+0.14 pp) on 408,629 orders, a change that is not statistically significant.
...
| 2_PreDunningAR | vs Step 1 | +0.32 pp | ✅ |
| 3_PostDunningAR | vs Step 2 | +0.02 pp | ✅ |
| 6_PaymentApprovalRate | Final | +0.14 pp | ✅ |

**Key Findings:**
- US showed healthy improvement of +0.34 pp (92.78% → 93.09%), with no countries exceeding the ±2.5% threshold
- PaymentProvider "Unknown" flagged with -3.36 pp decline (95.56% → 92.35%), but represents minimal volume (353 orders)
- All funnel stages showed positive movement, with FirstRunAR contributing the largest improvement (+0.44 pp)
- 8-week trend shows steady upward trajectory from 93.13% (W08) to 93.76% (W15), representing +0.63 pp cumulative gain
- Volume declined -1.7% week-over-week (415,885 → 408,629), continuing a gradual downward trend over the 8-week period
