#!/usr/bin/env python3
"""
Sync the validate_pre_spider_graph_data notebook to Databricks workspace
"""
...
def main():
    ...
    # Local file path
    local_file = Path(__file__).parent / "validate_pre_spider_graph_data"
    workspace_path = "/Workspace/Users/visal.kumar@hellofresh.com/validate_pre_spider_graph_data"
    
    print("=" * 80)
    print("Sync Validation Notebook to Databricks Workspace")
    print("=" * 80)
