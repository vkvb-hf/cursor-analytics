...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_checkout_funnel AS WITH union_all_base AS (
# MAGIC SELECT
# MAGIC   a.country,
# MAGIC   a.customer_id,
...
# MAGIC REFRESH TABLE dimensions.date_dimension;
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_checkout_funnel_backend AS
# MAGIC SELECT
# MAGIC   -- a.*,
# MAGIC   country,
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_empty_conversions AS WITH date_lkup AS (
# MAGIC   SELECT
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_box_candidates AS
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_dunning AS WITH date_lkup AS (
# MAGIC   SELECT
# MAGIC     hellofresh_week,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_month) AS hellofresh_year_month,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_quarter) AS hellofresh_year_quarter
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_reactivation_funnel AS with pvs_base as (
# MAGIC   select
# MAGIC     pvs.*,
# MAGIC     dd.quarter,
# MAGIC     dd.iso_year_week AS hellofresh_week,
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_psp_performance AS
# MAGIC SELECT
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_chargeback AS WITH date_lkup AS (
# MAGIC   SELECT
# MAGIC     hellofresh_week,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_month) AS hellofresh_year_month,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_quarter) AS hellofresh_year_quarter
...
# MAGIC REFRESH TABLE materialized_views.box_level_profit_contribution;
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_payment_cost AS WITH date_lkup AS (
# MAGIC   SELECT
# MAGIC     hellofresh_week,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_month) AS hellofresh_year_month,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_quarter) AS hellofresh_year_quarter
...
# MAGIC
# MAGIC   FROM materialized_views.box_level_profit_contribution pc
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_cash_credits AS WITH base AS (
# MAGIC   SELECT
...
# MAGIC
# MAGIC CREATE TABLE payments_hf.payments_p0_metrics_top_up_actives AS WITH date_lkup AS (
# MAGIC   SELECT
# MAGIC     hellofresh_week,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_month) AS hellofresh_year_month,
# MAGIC     CONCAT(dd.hellofresh_year, '-', dd.hellofresh_quarter) AS hellofresh_year_quarter
...
# MAGIC %md
# MAGIC # Steering meeting document:
