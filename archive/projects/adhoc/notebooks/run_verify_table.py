#!/usr/bin/env python3
"""
Run the table data verification
"""
...
def main():
    ...
    notebook_file = os.path.join(os.path.dirname(__file__), "verify_table_data.py")
    with open(notebook_file, 'r') as f:
        notebook_content = f.read()
    
    notebook_path = "/Workspace/Users/visal.kumar@hellofresh.com/verify_table_data"
    job_name = "verify_table_data"
    output_file = "/tmp/verify_table_data_results.txt"
    
    print("=" * 100)
    print("Verify Table Data Integrity")
    print("=" * 100)
