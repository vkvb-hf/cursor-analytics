#!/usr/bin/env python3
"""
Run the Nov 3 data verification
"""
...
def main():
    ...
    notebook_file = os.path.join(os.path.dirname(__file__), "verify_nov3_data.py")
    with open(notebook_file, 'r') as f:
        notebook_content = f.read()
    
    notebook_path = "/Workspace/Users/visal.kumar@hellofresh.com/verify_nov3_data"
    job_name = "verify_nov3_data"
    output_file = "/tmp/verify_nov3_data_results.txt"
    
    print("=" * 100)
    print("Verify Nov 3 Data in checkout_funnel_backend")
    print("=" * 100)
