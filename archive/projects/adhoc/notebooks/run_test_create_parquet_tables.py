#!/usr/bin/env python3
"""
Run the create_parquet_tables function test
"""
...
def main():
    ...
    notebook_file = os.path.join(os.path.dirname(__file__), "test_create_parquet_tables.py")
    with open(notebook_file, 'r') as f:
        notebook_content = f.read()
    
    notebook_path = "/Workspace/Users/visal.kumar@hellofresh.com/test_create_parquet_tables"
    job_name = "test_create_parquet_tables"
    output_file = "/tmp/test_create_parquet_tables_results.txt"
    
    print("=" * 100)
    print("Test: create_parquet_tables Function")
    print("=" * 100)
    ...
    print("=" * 100)
    print("\n⏱️  This test will:")
    print("   - Test the create_parquet_tables function")
    print("   - Create 3 temporary tables from Parquet files")
    print("   - Use 7 days of data")
    print("   - Measure execution time")
    print("   - Verify tables are created correctly")
    print("   - Clean up test tables after completion")
    print("=" * 100)
